...
ckpt_path = "ckpts/model_50_remove.pth"
image_path = "Dataset/TestDataset/CVC-300/images/154.png"
mask_path = "Dataset/TestDataset/CVC-300/masks/154.png"
# name = "304"
# image_path = f"Dataset/TestDataset/CVC-ClinicDB/images/{name}.png"
# mask_path = f"Dataset/TestDataset/CVC-ClinicDB/masks/{name}.png"

# image_path = f"Dataset/TestDataset/CVC-ColonDB/images/{name}.png"
# mask_path = f"Dataset/TestDataset/CVC-ColonDB/masks/{name}.png"
...
target_layers = [
    "model.decode_head.linear_projections[2]",
]
...
if __name__ == '__main__':
    ...
    with method(
        ...
        plt.show()
        # plt.savefig(os.path.join(save_folder, '_'.join(image_path.split('/')[-3:])))
